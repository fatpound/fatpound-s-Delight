...
namespace fatpound::automata
{
    ...
    CFGTree::CFGTree(const std::vector<std::pair<std::string, std::vector<std::string>>>& trees)
    {
    ...
    std::vector<std::pair<std::string, bool>> CFGTree::GetWords()
    {
        return results_;
    }


    std::vector<std::pair<std::string, bool>> CFGTree::Generate_(std::string init_str, size_t index, size_t recursed) const
    {
    ...
    bool CFGTree::IsTerminal_(const std::string& str) const
    {
    ...
    CFGTree::Node::Node(const std::pair<std::string, std::vector<std::string>>& tree)
        :
        item_(tree.first)
    {
    ...
    CFGTree::Node::Node(const std::string& str)
        :
        item_(str)
    {
